...
var load_iframe = document.getElementById('load');
unsafeWindow.load = load_iframe.contentWindow;
...
var lf = unsafeWindow.jsLoaderObject_loadFrom.toString()
   .replace('function jsLoaderObject_loadFrom',
            'window.jsLoaderObject_loadFrom = function')
